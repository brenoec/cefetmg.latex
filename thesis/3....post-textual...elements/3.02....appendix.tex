...
doutorado, conforme a norma \citeonline{NBR14724:2011}.
...
fins de admissão ao mesmo, conforme a norma \citeonline{NBR15287:2005}.
...
constituintes do projeto. Esse estilo é baseado nas normas da ABNT\index{ABNT}.
...
Enquanto \citeonline{Maturana2003} defendem uma epistemologia baseada na
...
No entanto, \citeonline[p.~33]{Silva2000}, ao fazerem as suas críticas à ciência
moderna, afirmam:
...
A epistemologia baseada na biologia de \citeonline[p.~35]{Maturana2003} parte
...
A seguir há mais exemplos dos comandos para as chamadas de referências e o
resultado produzido.
...
Há que se tomar bastante cuidado com referências cujos autores têm nomes
compostos, tipo João de Souza Júnior ou Antônio José da Silva Filho. Para que a
formatação seja correta, os nomes dos autores no arquivo {\ttfamily .bib} deverá
ser cadastrado de uma forma específica. Para maiores detalhes, veja o
\autopageref{chap:anexoB} \footnote{O texto do anexo é de inteira
responsabilidade do autor devidamente referenciado.}.
...
Observe que, a despeito do que está dito no \autoref{chap:anexoB}, ainda há
falhas na formatação ABNT de nomes tipo \verb|van Gelder| quando utilizados em
chamadas de referências que fazem parte do texto (\textit{e.g.},
\verb|\citeonline{vanGELDER1998}| que deveria produzir \verb|van Gelder
(1998)|). Este problema pode ser contornado facilmente, simplesmente evitando o
uso dessa forma de chamada de referência, preferindo sempre nestes casos, o uso
da forma \textit{e.g.}, \verb|\cite{vanGELDER1998}| que será formatada
corretamente, produzindo \verb|(van GELDER, 1998)|.

Observe ainda o caso em que é feita duas citações juntas
\cite{Santos2003, Neubert2001} e como citar endereços Web \cite{IRL2014}.
...
referências bibliográficas devem seguir a norma \citeonline{NBR6023:2002} da
...
Cada entrada é formatada pelo pacote \citeonline{abnTeX22014d} de uma forma
específica. Algumas entradas foram introduzidas especificamente para atender à
norma \citeonline{NBR6023:2002}, são elas: \verb|@monography|,
\verb|@journalpart|,\verb|@patent|. As demais entradas são padrão
\textsc{Bib}\TeX{}. Para maiores detalhes, refira-se a
\citeonline{abnTeX22014d}, \citeonline{abnTeX22014b}, \citeonline{abnTeX22014c}.
...
A própria  \citeonline{NBR6023:2002}, na seção 8.11.4, apresenta um exemplo com
a formatação diferente daquela proporcionada por \citeonline{abnTeX22014d}.
...
\citeonline{NBR6023:2002} requer que muitos dos campos do \textsc{Bib}\TeX{}
...
formatada de modo errado, no que concerne à norma \citeonline{NBR6023:2002}.
...
\citeonline{NBR6023:2002}. Para detalhes dos campos utilizados confira o arquivo
...
A norma \citeonline{NBR10520:2002}, em sua seção \textbf{7 Notas de rodapé},
...
na seção \textbf{7.1 Notas de referência} da norma \citeonline{NBR10520:2002}.
